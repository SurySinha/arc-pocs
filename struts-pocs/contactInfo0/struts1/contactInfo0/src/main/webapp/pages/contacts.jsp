...
<body>
    ...
    <c:if test="${!contactForm.hideAddNewLink}">
        <html:form action="/hideAddNew" method="post" styleId="addnewform">
    ...
    <html:form styleId="contactForm" action="/addNew" method="post" styleClass="form">
